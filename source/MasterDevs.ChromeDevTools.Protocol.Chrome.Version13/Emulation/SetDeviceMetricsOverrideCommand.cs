...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Version13.Emulation
{
	...
	[SupportedBy("Chrome")]
	public class SetDeviceMetricsOverrideCommand: ICommand<SetDeviceMetricsOverrideCommandResult>
	{
		public string MethodName { get; } = ProtocolName.Emulation.SetDeviceMetricsOverride;
		/// <summary>
