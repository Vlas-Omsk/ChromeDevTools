...
namespace MasterDevs.ChromeDevTools.Protocol.Version13.Chrome
{
	public static class ProtocolName
	{
		...
		public static class Debugger
		{
			...
			public const string DisassembleWasmModule = "Debugger.disassembleWasmModule";
			public const string NextWasmDisassemblyChunk = "Debugger.nextWasmDisassemblyChunk";
		...
		public static class Runtime
		{
			...
			public const string GetExceptionDetails = "Runtime.getExceptionDetails";
		...
		public static class Accessibility
		{
			...
			public const string GetRootAXNode = "Accessibility.getRootAXNode";
			public const string GetAXNodeAndAncestors = "Accessibility.getAXNodeAndAncestors";
			...
			public const string LoadComplete = "Accessibility.loadComplete";
			public const string NodesUpdated = "Accessibility.nodesUpdated";
		}
		...
		public static class CSS
		{
			...
			public const string GetLayersForNode = "CSS.getLayersForNode";
			...
			public const string SetSupportsText = "CSS.setSupportsText";
			public const string SetScopeText = "CSS.setScopeText";
		...
		public static class Cast
		{
			...
			public const string StartDesktopMirroring = "Cast.startDesktopMirroring";
		...
		public static class DOM
		{
			...
			public const string GetTopLayerElements = "DOM.getTopLayerElements";
			...
			public const string TopLayerElementsUpdated = "DOM.topLayerElementsUpdated";
		...
		public static class EventBreakpoints
		{
			public const string SetInstrumentationBreakpoint = "EventBreakpoints.setInstrumentationBreakpoint";
			public const string RemoveInstrumentationBreakpoint = "EventBreakpoints.removeInstrumentationBreakpoint";
		}
		...
		public static class Emulation
		{
			...
			public const string SetHardwareConcurrencyOverride = "Emulation.setHardwareConcurrencyOverride";
			public const string SetUserAgentOverride = "Emulation.setUserAgentOverride";
			public const string SetAutomationOverride = "Emulation.setAutomationOverride";
		...
		public static class Network
		{
			...
			public const string ReportingApiEndpointsChangedForOrigin = "Network.reportingApiEndpointsChangedForOrigin";
		}
		...
		public static class Overlay
		{
			...
			public const string SetShowIsolatedElements = "Overlay.setShowIsolatedElements";
		...
		public static class Page
		{
			...
			public const string GetAdScriptId = "Page.getAdScriptId";
			...
			public const string SetSPCTransactionMode = "Page.setSPCTransactionMode";
			public const string SetRPHRegistrationMode = "Page.setRPHRegistrationMode";
		...
		{
			public const string GetStorageKeyForFrame = "Storage.getStorageKeyForFrame";
			public const string ClearDataForOrigin = "Storage.clearDataForOrigin";
			public const string ClearDataForStorageKey = "Storage.clearDataForStorageKey";
			...
			public const string TrackCacheStorageForStorageKey = "Storage.trackCacheStorageForStorageKey";
			public const string TrackIndexedDBForOrigin = "Storage.trackIndexedDBForOrigin";
			public const string TrackIndexedDBForStorageKey = "Storage.trackIndexedDBForStorageKey";
			public const string UntrackCacheStorageForOrigin = "Storage.untrackCacheStorageForOrigin";
			public const string UntrackCacheStorageForStorageKey = "Storage.untrackCacheStorageForStorageKey";
			public const string UntrackIndexedDBForOrigin = "Storage.untrackIndexedDBForOrigin";
			public const string UntrackIndexedDBForStorageKey = "Storage.untrackIndexedDBForStorageKey";
			public const string GetTrustTokens = "Storage.getTrustTokens";
			public const string ClearTrustTokens = "Storage.clearTrustTokens";
			public const string GetInterestGroupDetails = "Storage.getInterestGroupDetails";
			public const string SetInterestGroupTracking = "Storage.setInterestGroupTracking";
			public const string GetSharedStorageMetadata = "Storage.getSharedStorageMetadata";
			public const string GetSharedStorageEntries = "Storage.getSharedStorageEntries";
			public const string SetSharedStorageEntry = "Storage.setSharedStorageEntry";
			public const string DeleteSharedStorageEntry = "Storage.deleteSharedStorageEntry";
			public const string ClearSharedStorageEntries = "Storage.clearSharedStorageEntries";
			public const string ResetSharedStorageBudget = "Storage.resetSharedStorageBudget";
			public const string SetSharedStorageTracking = "Storage.setSharedStorageTracking";
			...
			public const string InterestGroupAccessed = "Storage.interestGroupAccessed";
			public const string SharedStorageAccessed = "Storage.sharedStorageAccessed";
		}

		public static class SystemInfo
		{
			public const string GetInfo = "SystemInfo.getInfo";
			public const string GetFeatureState = "SystemInfo.getFeatureState";
		...
		public static class WebAuthn
		{
			...
			public const string SetResponseOverrideBits = "WebAuthn.setResponseOverrideBits";
			...
			public const string CredentialAdded = "WebAuthn.credentialAdded";
			public const string CredentialAsserted = "WebAuthn.credentialAsserted";
		}
		...
		{
			public const string Enable = "DeviceAccess.enable";
			public const string Disable = "DeviceAccess.disable";
			public const string SelectPrompt = "DeviceAccess.selectPrompt";
			public const string CancelPrompt = "DeviceAccess.cancelPrompt";
			public const string DeviceRequestPrompted = "DeviceAccess.deviceRequestPrompted";
		}

		public static class Preload
		{
			public const string Enable = "Preload.enable";
			public const string Disable = "Preload.disable";
			public const string RuleSetUpdated = "Preload.ruleSetUpdated";
			public const string RuleSetRemoved = "Preload.ruleSetRemoved";
			public const string PrerenderAttemptCompleted = "Preload.prerenderAttemptCompleted";
			public const string PrefetchStatusUpdated = "Preload.prefetchStatusUpdated";
			public const string PrerenderStatusUpdated = "Preload.prerenderStatusUpdated";
			public const string PreloadingAttemptSourcesUpdated = "Preload.preloadingAttemptSourcesUpdated";
		}

		public static class FedCm
		{
			public const string Enable = "FedCm.enable";
			public const string Disable = "FedCm.disable";
			public const string SelectAccount = "FedCm.selectAccount";
			public const string DismissDialog = "FedCm.dismissDialog";
			public const string DialogShown = "FedCm.dialogShown";
		}
