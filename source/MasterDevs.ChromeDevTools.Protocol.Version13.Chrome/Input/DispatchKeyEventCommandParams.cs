...
namespace MasterDevs.ChromeDevTools.Protocol.Version13.Chrome.Input
{
	...
	[SupportedBy("Chrome")]
	public class DispatchKeyEventCommandParams: ICommandParams<DispatchKeyEventCommandResult>
	{
		public string MethodName { get; } = ProtocolName.Input.DispatchKeyEvent;
		/// <summary>
